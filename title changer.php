 ...
 */
function deactivate_title changer() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-title changer-deactivator.php';
	Title_Changer_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_title changer' );
register_deactivation_hook( __FILE__, 'deactivate_title changer' );
